...
!function(e, t) {
    ...
    function K(e, t) {
        if (t) {
            if (i.escapeTest.test(e))
                return e.replace(i.escapeReplace, J)
        } else if (i.escapeTestNoEncode.test(e))
            return e.replace(i.escapeReplaceNoEncode, J);
        return e
    }
    function V(e) {
        try {
    ...
    class te {
        ...
        table(e) {
            ...
            if (n.length === s.length) {
                ...
                for (const e of r)
                    i.rows.push(W(e, i.header.length).map(( (e, t) => ({
                        text: e,
                        tokens: this.lexer.inline(e),
                        header: !1,
                        align: i.align[t]
    ...
    class ne {
        ...
        constructor(t) {
            ...
            this.options.pedantic ? (n.block = X.pedantic,
            n.inline = F.pedantic) : this.options.gfm && (n.block = X.gfm,
    ...
    class se {
        ...
        listitem(e) {
            ...
            if (e.task) {
                ...
                e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && "text" === e.tokens[0].tokens[0].type && (e.tokens[0].tokens[0].text = n + " " + K(e.tokens[0].tokens[0].text),
